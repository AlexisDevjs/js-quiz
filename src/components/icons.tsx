...
export function ToggleThemeIcon (props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      aria-hidden='true'
...
export function SettingsIcon (props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      strokeLinecap='round'
      strokeLinejoin='round'
      className='icon icon-tabler icons-tabler-outline icon-tabler-settings-cog size-6.5 text-black dark:text-white'
      {...props}
    >
